...
class Together(LLM):
    ...
    base_url: str = "https://genai-connector-develop-fxudoqoheq-ww.a.run.app/predict"
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        headers = {
            'x-api-key': self.together_api_key,
...
# # Example of how to instantiate the custom class
